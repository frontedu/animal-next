...
export default function Navbar() {
  return (
    <nav className="navbar-container py-4 px-3 px-lg-0 navbar navbar-expand-lg">
      <div className="container pb-0 pb-lg-2 px-2 px-lg-0">
        ...
        >
          <span className="menu navbar-toggler-icon"></span>
        </button>
        <div className="navbar-collapse" id="navbar">
          <ul className="ms-auto navbar-nav gap-4">
            <li className="nav-item">
              <Link className="nav-link" href="/">
                <div className="d-inline fs-5 pointer">Início</div>
              </Link>
            </li>

            <li className="nav-item">
              <Link className="nav-link disabled" href="recursos/">
                <div className="d-inline fs-5 pointer">Recursos</div>
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" href="planos/">
                <div className="d-inline fs-5 pointer">Planos</div>
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" href="mailto:oiedu@icloud.com">
                <div className="d-inline fs-5">Ajuda</div>
              </Link>
            </li>
            <li className="nav-item position-relative">
              <Link className="nav-link signs s1" href="/login/">
                <div className="d-inline fs-5 pointer">Entrar</div>
              </Link>
            </li>
            <li className="dropdown nav-item position-relative">
              <Link className="nav-link signs s2" href="/sign-up/">
                <div className="d-inline fs-5 pointer">Registre-se</div>
