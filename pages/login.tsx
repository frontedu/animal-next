    ...
    <svg
      ...
      <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
        <div className="px-5 py-7">
          <label className="font-semibold text-sm text-gray-600 pb-1 block">E-mail ou usuário</label>
        ...
        <Link href="/dashboard/">
            <button type="button" className="transition duration-200 bg-[#33C4C4] hover:[#2FADAD] focus:[#2FADAD] focus:shadow-sm focus:ring-4 focus:ring-[#33C4C4] focus:ring-opacity-50 text-white w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center inline-block">
        ...
        <div className="p-5">
            <h3 className="font-semibold text-sm text-gray-600 pb-1 block">Primeiro acesso?</h3>
            <div className="grid grid-cols-3 gap-1">

                <Link href="/sign-up/pessoa-fisica/">
                    <button type="button" className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block">Pessoa física</button>
                </Link>

                <Link href="/sign-up/pessoa-juridica/">
                    <button type="button" className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block">Pessoa jurídica</button>
                </Link>
          ...
          <div className="grid grid-cols-2 gap-1">
            <div className="text-center sm:text-left whitespace-nowrap">
             ...
             <button className="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                  ...
                  <span className="inline-block ml-1">Esqueceu a senha?</span>
              </button> 
             </Link>   
            ...
            <div className="text-center sm:text-right whitespace-nowrap">
             ...
             <Link href="mailto:contato@animalsystem.com.br">
             <button className="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-4 h-4 inline-block align-text-bottom	">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z" />
                  </svg>
                  <span className="inline-block ml-1">Suporte</span>
              </button>
             </Link>   
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-1">
            <div className="text-center sm:text-left whitespace-nowrap">
                ...
                <button className="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-200 focus:outline-none focus:bg-gray-300 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                        ...
                        <span className="inline-block ml-1">voltar à página inicial</span>
                    </button>
                </Link>
            </div>
          </div>
